...
public class ContactsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toolbarManager = new ToolbarManager(ContactsActivity.this, toolbar);

        ActivityCompat.requestPermissions(ContactsActivity.this, new String[]{READ_CONTACTS}, 0);
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions, @NonNull int[] grantResults) {
        ...
        ((ListView) findViewById(R.id.lvContacts)).setAdapter(adapter);

        ((EditText) findViewById(R.id.etFilter)).addTextChangedListener(new TextWatcher() {
            @Override
            ...
            do {
                ...
                if (dataCursor.moveToFirst()) {
                    ...
                    if (!contactNumbers.isEmpty()) {
                        ...
                        for (int i = 1; i < contactNumbers.length(); i++) {
                            if (contactNumbers.charAt(i) == 'n' &&
                                    contactNumbers.charAt(i - 1) >= '0'
                                    && contactNumbers.charAt(i - 1) <= '9') {
                                contactNumbers = contactNumbers.substring(0, i)
                                       + "\n" + contactNumbers.substring(i + 1);
                            }
                        }
                    }
